...
class MDN_ProductReturn_AdminController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function DeleteAction()
    {
        ...
        $this->_redirect('ProductReturn/Admin/Grid');
    }
    ...
    public function ReserveProductAction()
    {
        ...
        //redirect
        $this->_redirect('ProductReturn/Admin/Edit', array('rma_id' => $rmaId, 'tab' => 'reservation'));
    }

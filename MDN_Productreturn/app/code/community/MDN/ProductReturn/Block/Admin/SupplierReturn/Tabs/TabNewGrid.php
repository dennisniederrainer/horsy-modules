...
class MDN_ProductReturn_Block_Admin_SupplierReturn_Tabs_TabNewGrid extends Mage_Adminhtml_Block_Widget_Grid
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('TabNewGrid');
    ...
    {
        $collection = Mage::helper('ProductReturn/SupplierReturn')->getNewSupplierReturns();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('ProductReturn/SupplierReturn/exportCsv/type/SupplierReturnNew', Mage::helper('customer')->__('CSV'));

...
class MDN_ProductReturn_Block_Admin_SupplierReturn_Tabs_TabSentToSupplierGrid extends Mage_Adminhtml_Block_Widget_Grid
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('TabSentToSupplierGrid');
    ...
    {
        $collection = Mage::helper('ProductReturn/SupplierReturn')->getSentSupplierReturns();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('ProductReturn/SupplierReturn/exportCsv/type/SupplierReturnSentToSupplier', Mage::helper('customer')->__('CSV'));
    ...
    {
        return $this->getUrl('ProductReturn/SupplierReturn/edit', array('rsr_id' => $row->getrsr_id()));
    }

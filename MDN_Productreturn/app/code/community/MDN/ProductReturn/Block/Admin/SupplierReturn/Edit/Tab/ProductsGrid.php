...
class MDN_ProductReturn_Block_Admin_SupplierReturn_Edit_Tab_ProductsGrid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('process_status_refunded', array(
            ...
            'url'   => $this->getUrl('ProductReturn/ProductsPendingSupplierReturn/MassProcess', array('status' => MDN_ProductReturn_Model_SupplierReturn_Product::kProductStatusRefunded, 'rsr_id' => $this->getRsrId())),
        ));
        ...
        $this->getMassactionBlock()->addItem('process_status_standard_exchange', array(
            ...
            'url'   => $this->getUrl('ProductReturn/ProductsPendingSupplierReturn/MassProcess', array('status' => MDN_ProductReturn_Model_SupplierReturn_Product::kProductStatusStandardExchange, 'rsr_id' => $this->getRsrId())),
        ));
        ...
        $this->getMassactionBlock()->addItem('process_status_creditmemo', array(
            ...
            'url'   => $this->getUrl('ProductReturn/ProductsPendingSupplierReturn/MassProcess', array('status' => MDN_ProductReturn_Model_SupplierReturn_Product::kProductStatusCreditMemo, 'rsr_id' => $this->getRsrId())),
        ));
        ...
        $this->getMassactionBlock()->addItem('process_status_destroy', array(
            ...
            'url'   => $this->getUrl('ProductReturn/ProductsPendingSupplierReturn/MassProcess', array('status' => MDN_ProductReturn_Model_SupplierReturn_Product::kProductStatusDestroy, 'rsr_id' => $this->getRsrId())),
        ));
        ...
        $this->getMassactionBlock()->addItem('remove_from_rsr', array(
            ...
            'url'   => $this->getUrl('ProductReturn/ProductsPendingSupplierReturn/MassRemoveProductsFromRsr', array('rsr_id' => $this->getRsrId())),
        ));

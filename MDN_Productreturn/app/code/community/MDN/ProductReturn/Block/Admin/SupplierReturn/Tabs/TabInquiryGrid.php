...
class MDN_ProductReturn_Block_Admin_SupplierReturn_Tabs_TabInquiryGrid extends Mage_Adminhtml_Block_Widget_Grid
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('TabInquiryGrid');
    ...
    {
        $collection = Mage::helper('ProductReturn/SupplierReturn')->getInquirySupplierReturns();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('ProductReturn/SupplierReturn/exportCsv/type/SupplierReturnInquiry', Mage::helper('customer')->__('CSV'));

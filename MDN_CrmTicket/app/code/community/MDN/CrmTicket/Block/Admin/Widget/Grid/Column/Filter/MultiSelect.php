 ...
 * @version 1.2
 */
class MDN_CrmTicket_Block_Admin_Widget_Grid_Column_Filter_MultiSelect extends Mage_Adminhtml_Block_Widget_Grid_Column_Filter_Abstract
{
    ...
    public function getCondition()
    {
        ...
        {
            return array('in' => array_keys($this->getValue()));
        }
        else
            return null;
    }

 ...
 * @version 1.2
 */
class MDN_CrmTicket_Block_Adminhtml_ProductReturn_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
  ...
  public function __construct()
  {
      ...
      $this->setId('productreturn_ticket');
  ...
  {
      $collection = mage::helper('CrmTicket/ProductReturn')->getTicketsByProductReturnId($this->getRequest()->getParam('rma_id'));

...
class SNMFPDF_TPL extends SNMFPDF {
	/**
	 * Array of Tpl-Data
	 * @var array
	 */
	...
	function beginTemplate($x = null, $y = null, $w = null, $h = null) {
		if (is_subclass_of($this, 'SNMTCPDF')) {
	...
	function endTemplate() {
		if (is_subclass_of($this, 'SNMTCPDF')) {
			$args = func_get_args();
			return call_user_func_array(array($this, 'SNMTCPDF::endTemplate'), $args);
		}
	...
	public function SetFont($family, $style = '', $size = 0,$fontfile='', $subset='default') {
		if (is_subclass_of($this, 'SNMTCPDF')) {
			$args = func_get_args();
			return call_user_func_array(array($this, 'SNMTCPDF::SetFont'), $args);
		}
	...
	//	function Image($file, $x = null, $y = null, $w = 0, $h = 0, $type = '', $link = '') {
		if (is_subclass_of($this, 'SNMTCPDF')) {
			$args = func_get_args();
			return call_user_func_array(array($this, 'SNMTCPDF::Image'), $args);
		}
	...
	function AddPage($orientation = '', $format = '', $keepmargins=false, $tocpage=false) {
		if (is_subclass_of($this, 'SNMTCPDF')) {
			$args = func_get_args();
			return call_user_func_array(array($this, 'SNMTCPDF::AddPage'), $args);
		}
	...
	function Link($x, $y, $w, $h, $link, $spaces=0) {
		if (is_subclass_of($this, 'SNMTCPDF')) {
			$args = func_get_args();
			return call_user_func_array(array($this, 'SNMTCPDF::Link'), $args);
		}
	...
	function AddLink() {
		if (is_subclass_of($this, 'SNMTCPDF')) {
			$args = func_get_args();
			return call_user_func_array(array($this, 'SNMTCPDF::AddLink'), $args);
		}
	...
	function SetLink($link, $y = 0, $page = -1) {
		if (is_subclass_of($this, 'SNMTCPDF')) {
			$args = func_get_args();
			return call_user_func_array(array($this, 'SNMTCPDF::SetLink'), $args);
		}

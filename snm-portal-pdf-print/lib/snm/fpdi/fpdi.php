...
define('SNMFPDI_VERSION', '1.4.1');

// Check for SNMTCPDF and remap SNMTCPDF to FPDF
/*
if (class_exists('SNMTCPDF', false)) {
    require_once('fpdi2tcpdf_bridge.php');
}
*/
require_once(dirname(__FILE__).'/fpdi2tcpdf_bridge.php');
require_once(dirname(__FILE__).'/fpdf_tpl.php');
require_once('fpdi_pdf_parser.php');


class SNMFPDI extends SNMFPDF_TPL {
    /**
     * Actual filename
     * @var string
     */
    ...
    function _getPdfParser($filename) {
    	return new snmfpdi_pdf_parser($filename, $this);
    }
    ...
    function _newobj($obj_id = false, $onlynewobj = false) {
        ...
        //Begin a new object
        if (!$onlynewobj) {
            $this->offsets[$obj_id] = is_subclass_of($this, 'SNMTCPDF') ? $this->bufferlen : strlen($this->buffer);

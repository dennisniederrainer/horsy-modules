...
class MDN_AdvancedStock_Model_Sales_Resource_Order_Item_Collection extends Mage_Sales_Model_Resource_Order_Item_Collection {
    ...
    public function joinErpTable() {
        ...
        $this->getSelect()->joinLeft(
                ...
                array('preparation_warehouse', 'reserved_qty', 'comments', 'esfoi_item_id'));

...
class MDN_AdvancedStock_Block_Inventory_Edit_Tabs_ApplyInventory extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function initForm()
    {
        ...
        $fieldset = $form->addFieldset('apply_fieldset',
            array('legend'=>Mage::helper('AdvancedStock')->__('Apply inventory'))
        );
        ...
        $datas['apply_comment'] = $this->__('Applying the inventory will fix product stock levels for the current warehouse based on the data in differences tab. This operation can not be rollbacked');
